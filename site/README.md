...
- 共创工坊使用 A 组 4 段音频，儿童豫剧四声腔使用 B 组 4 段，长者点戏使用 C 组 4 段，红色戏曲专题使用 D 组 2 段；红色戏曲页面同时提供 A-D 四组共 14 段完整曲目总览。
- 首页使用单一项目 IP，在首屏右下角安全区轻微浮动并支持点击互动；生旦净丑四张卡通人物图归入儿童专区“行当”页签展示。
